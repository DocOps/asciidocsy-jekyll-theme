...
:page-version-handlers: +user-os-toggle
= Class Toggles
...
To toggle an entire section, add a class to the heading and group the rest in an [.term.open-block-asciidoc]*open block*, and assign a class to it.
...
The markup behind that content is easy to distinguish and edit.
